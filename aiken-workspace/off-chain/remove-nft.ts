...
import { createLucidInstance, getCredential } from "./utils/lucid/utils.js";
import { APPLIED_VALIDATOR_PATH } from "./common/constants.js";
...
const storeValidator: AppliedValidator = JSON.parse(
  await Deno.readTextFile(APPLIED_VALIDATOR_PATH + "reference_store.store.json")
);
...
const tx = lucid.newTx().collectFrom(scriptUtxos, rdmr);
