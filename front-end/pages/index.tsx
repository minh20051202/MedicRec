...
export default function Home() {
  return (
    <div>
        ...
        <div className="box-container">
          <div className="box">
            ...
            <div className="content">
              ...
              <p>
                Bản thân công ty đã là một công ty rất thành công. Từ nhu cầu
                của mọi người, anh ấy nhận được trách nhiệm lớn lao từ nỗi đau.
              </p>
              <a href="#">
      ...
      >
        <h1 style={{ justifyContent: "center", fontSize: "30px" }}>
          Đánh giá của bạn
        </h1>
        <h3
          style={{ marginBottom: "15px", marginTop: "10px", fontSize: "15px" }}
        >
          Chúng tôi rất mong nhận được ý kiến đóng góp từ bạn để cải thiện dịch
          vụ tốt hơn.
        </h3>
      ...
      <section id="review" className="review">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <p>
              "Blockchain giúp việc chia sẻ thông tin y tế giữa các bệnh viện
              nhanh chóng và an toàn hơn. Tôi đã từng phải chuyển viện và thấy
              quá trình này được thực hiện dễ dàng hơn nhờ công nghệ này."
            </p>
          ...
          <div className="box">
            <i className="fas fa-quote-left"></i>
            <p>
              "Tôi rất hài lòng với hệ thống này. Hồ sơ y tế của tôi luôn được
              cập nhật chính xác và không có sai sót. Blockchain giúp tôi yên
              tâm vì thông tin của mình không bị giả mạo hay chỉnh sửa."
            </p>
          ...
          <div className="box">
            <i className="fas fa-quote-left"></i>
            <p>
              "Tôi cảm thấy an tâm hơn khi biết rằng hồ sơ y tế của mình được
              bảo mật qua công nghệ Blockchain. Mọi thông tin đều được lưu trữ
              an toàn và không thể bị thay đổi, giúp tôi tin tưởng hơn vào chất
              lượng dịch vụ."
            </p>
        ...
        <div className="box-container">
          <div className="box">
            ...
            <div className="content">
              ...
              <p>
                ...
                quản lý chế độ ăn uống, hoạt động thể chất, theo dõi đường huyết
                và điều trị bằng thuốc, nhằm giúp bệnh nhân kiểm soát bệnh tật
          ...
          <div className="box">
            ...
            <div className="content">
              ...
              <p>
                "Để phòng ngừa bệnh tật, bệnh viện chúng tôi cam kết cung cấp
                các chương trình kiểm tra sức khỏe định kỳ, tư vấn dinh dưỡng và
