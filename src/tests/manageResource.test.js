import { FHIR_CLIENT, createFHIRBundle } from "../utils/manageResource.js";
...
// Lưu bundle vào file JSON

fs.writeFileSync("fhir_bundle.json", JSON.stringify(bundle, null, 2));

console.log("FHIR Bundle đã được tạo và lưu vào fhir_bundle.json");
